...
class Problem {
  public static int makingAnagrams(String a, String b) {
    ...
    // Making local mutable copy of b
    String c = b;
    int count = 0;
    for (char x : a.toCharArray()) {
      if (c.contains(Character.toString(x))) {
        count = count + 1;
        c = c.replaceFirst(Character.toString(x), " ");
      }
    }
    return n - 2 * count;
  }
...
public class MakingAnagrams {
  public static void main(String[] args) {
    ...
    System.out.println("The minimum number of character deletions \nrequired to make "+a+" and "+b+" anagrams: "+Problem.makingAnagrams(a, b));
  }
}
